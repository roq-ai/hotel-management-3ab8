  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless hotel operations with Hotel Management System - A comprehensive platform for managing bookings, payments, rooms, and more, powered by PHP, JavaScript, Bootstrap, and CSS. Simplifying hotel management for admins and booking process for users."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1590073844006-33379778ae09?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxob3RlbHxlbnwwfHx8fDE2OTUzMTg5NjJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@boxedwater?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Boxed Water Is Better`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless hotel operations with Hotel Management System - A comprehensive platform for managing bookings, payments, rooms, and more, powered by PHP, JavaScript, Bootstrap, and CSS. Simplifying hotel management for admins and booking process for users.`}
            </Text>
            <Box
