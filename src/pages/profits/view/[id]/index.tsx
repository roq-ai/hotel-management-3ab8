...
import { getProfitById } from 'apiSdk/profits';
import { ProfitInterface } from 'interfaces/profit';

function ProfitViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('profit', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/profits/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  label="Month"
                  text={data?.month ? format(parseISO(data?.month as unknown as string), 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Total Profit" text={data?.total_profit} />
